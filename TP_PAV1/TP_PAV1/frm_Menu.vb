        ...
        If validaciones_pestaña() Then      'Si los campos estan cargados correctamente
            Select Case pestaña
                ...
                Case 5
                    ...
                    insert_garantia = "descripcion=" & Me.txt_garantia_descripcion.Text & " , valorMonetario=" & Me.txt_garantia_monto.Text & " , idGarantia=" & Me.txt_garantia_idCredito.Text
        ...
        If validacion._validar_campos_vacios() Then
            Select Case pestaña_abm
                Case 0
                    ...
                    If validacion._validar_abogado(abogado) Then
                        resultado = True
                    End If
                Case 1
                    ...
                    If validacion._validar_solicitante(solicitante) Then
                        resultado = True
                    End If
                Case 2
                    ...
                    If validacion._validar_empleado(empleado) Then
                        resultado = True
                    End If
                Case 3
                    Dim credito As New Validacion.credito With {
                        .monto = Me.txt_creditos_monto.Text,
                        .fecha_solicitud = Me.txt_creditos_fSolicitud.Text,
                        .fecha_aprobacion = Me.mtxt_creditos_fAprobacion.Text,
                        .idSolicitante = Me.txt_creditos_idSolicitante.Text,
                        .legajo = Me.txt_creditos_legajo.Text,
                        .estado = Me.cmb_creditos_estadoCredito.SelectedIndex + 1,
                        .idObjeto = Me.txt_creditos_idObjeto.Text,
                        .objeto_nombre = Me.txt_creditos_objeto.Text
                    }

                    If validacion._validar_credito(credito) Then
                        resultado = True
                    End If
                ...
                Case 4
                    ...
                    If validacion._validar_expediente(expediente) Then
                        resultado = True
                    End If
            End Select
        End If
