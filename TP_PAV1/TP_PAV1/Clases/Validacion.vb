...
Public Class Validacion
    ...
    Structure expediente
        ...
        Public estado_credito As Integer
    ...
    Friend Function _validar_doc_tdoc(ByVal doc As Integer, ByVal tdoc As Integer) As Boolean
        Dim consulta As String = "SELECT * FROM Solicitante WHERE numeroDocumento=" & doc & " AND tipo_Documento_idTipo_Documento=" & tdoc
